...
//Aufgabe 10 in zusammenarbeit mit Marie und Lea//
interface ToDoObject { //Aus zwei Arrays wird ein Array mit Objekten//
    todosText: string;
...
function deleteTodo(index: number): void {
    ...
    todoObjects.splice(index, 1); //Mit unshift wird Array am Anfang eingefügt//
