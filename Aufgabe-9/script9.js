// Aufgabe 9//
//Array für die ToDos//
let todoitems = ["spending my whole time on EIA", "having no time for other stuff", "mental breakdown"];
window.addEventListener("load", function () {
    // To Do wird der Liste hinzugefügt (pushen ins Array)//
    var todobox = document.querySelector(".addlist"); //für DOM manipulation//
    todolist();
    var input = document.querySelector("#input");
    console.log(input);
    var button = document.querySelector("#But1"); //Addbutton
